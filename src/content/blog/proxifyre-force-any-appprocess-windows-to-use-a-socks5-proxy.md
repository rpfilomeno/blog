...
- **Process Exclusions:** As of v2.1.1, ProxiFyre supports **process exclusions**, allowing you to specify applications that should _bypass_ the proxy, even if a global proxy is configured.
...
- **Ensure Uniformity:** Apply a single, controlled proxy connection for _all_ applications, extending the capability that most applications lack.
